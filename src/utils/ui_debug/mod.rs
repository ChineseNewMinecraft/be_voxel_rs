...
pub fn ui_debug(image:&[u8],image_dimensions:(u32,u32)){
    unsafe {
        use ash::util::*;
        ...
        let base = renderer::ExampleBase::new(1024, 768, &evtl);
        ...
        let image_buffer_info = vk::BufferCreateInfo {
            size: (std::mem::size_of::<u8>() * image.len()) as u64,
        ...
        image_slice.copy_from_slice(image);
        ...
        let mut vertex_spv_file = Cursor::new(&include_bytes!("./shaders/tv.spv")[..]);
        let mut frag_spv_file = Cursor::new(&include_bytes!("./shaders/tf.spv")[..]);
        ...
        evtl.run(move |event, _, control_flow| {
            use winit::{
